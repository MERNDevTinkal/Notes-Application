        ...
        <div className="min-h-screen flex justify-center items-center bg-[#0f172a] px-4">
            ...
            >
                ...
                <button
                    ...
                    className={`w-full py-3 text-white font-semibold rounded-xl transition-transform duration-300 hover:scale-[1.03] ${isSubmitting ? 'bg-gray-600' : 'bg-indigo-600 hover:bg-indigo-700'
                        } cursor-pointer`}
                >
                    {isSubmitting ? (
